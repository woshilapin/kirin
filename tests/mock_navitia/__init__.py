...
mocks = [
    ...
    st_713065.response,
    st_713666.response,
    vj_20201022_23186.response,
    vj_20201022_23187.response,
    company_1187.response,
    company_piv_1187.response,
    ...
    st_piv_85010082.response,
    st_piv_85010116.response,
    st_piv_85010124.response,
    st_piv_85010132.response,
    st_piv_85010140.response,
    st_piv_85010157.response,
    st_piv_85010207.response,
    st_piv_85010215.response,
    st_piv_85010223.response,
    st_piv_85010231.response,
    st_piv_85161554.response,
    st_piv_85162727.response,
    st_piv_85162735.response,
    st_piv_85162750.response,
    st_piv_85162834.response,
    st_piv_85171421.response,
    st_piv_87745497.response,
